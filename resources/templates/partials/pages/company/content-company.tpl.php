<?php $fade_out_settings = 'data-aos="fade-up" data-aos-delay="700" data-aos-duration="1500"'; ?>
<div id="page-company">
    ...
    <div class="company-section">
        <div class="grid-container">
            <div class="company-history">
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell small-6 large-6 medium-6"></div>
                    <div class="cell small-6 medium-6 large-6" id="history-1">
                        <div class="company-history-item company-history-item--right">
                            <div class="company-history-item-image"></div>
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    ...
                    <div class="cell small-6 medium-5 large-5" id="history-2">
                        <div class="company-history-item company-history-item--left">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell small-6 large-6 medium-6"></div>
                    <div class="cell small-6 medium-6 large-6" id="history-3">
                        <div class="company-history-item company-history-item--right">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell large-1 medium-1"></div>
                    <div class="cell small-6 medium-5 large-5" id="history-4">
                        <div class="company-history-item company-history-item--left">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell small-6 large-6 medium-6"></div>
                    <div class="cell small-6 medium-6 large-6" id="history-5">
                        <div class="company-history-item company-history-item--right">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell large-1 medium-1"></div>
                    <div class="cell small-6 medium-5 large-5" id="history-6">
                        <div class="company-history-item company-history-item--left">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell small-6 large-6 medium-6"></div>
                    <div class="cell small-6 medium-6 large-6" id="history-7">
                        <div class="company-history-item company-history-item--right">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell large-1 medium-1"></div>
                    <div class="cell small-6 medium-5 large-5" id="history-8">
                        <div class="company-history-item company-history-item--left">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell small-6 large-6 medium-6"></div>
                    <div class="cell small-6 medium-6 large-6" id="history-9">
                        <div class="company-history-item company-history-item--right">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
                ...
                <div class="grid-x align-middle" <?php echo $fade_out_settings; ?>>
                    <div class="cell large-1 medium-1"></div>
                    <div class="cell small-6 medium-5 large-5" id="history-10">
                        <div class="company-history-item company-history-item--left">
                            <div class="company-history-item-image"></div>
                            <div class="company-history-item-year">
    ...
    <div class="company-section" id="marchio-storico">
        <div class="grid-container">
            <div class="grid-x grid-margin-x align-middle">
                <div class="cell small-12 medium-12 large-6 company-historic-brand-col1">
