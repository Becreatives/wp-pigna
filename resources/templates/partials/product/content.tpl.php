    ...
    <div class="grid-x">
            ...
            <div class="cell large-3 medium-6 small-12  align-middle">
                <div class="--card">
                    <div class="slider-product">
                        <div id="product-slider-<?= $key; ?>" class="orbit product-slider product-slider-<?= $key; ?>"
                             role="region"
        ...
        foreach ($products as $key => $product) :
            ...
            <div class="cell large-3 medium-6 small-12  align-middle">
                <div class="--card">
                    <div class="slider-product">
                        <div id="product-slider-n<?= $key; ?>" class="orbit product-slider product-slider-n<?= $key; ?>"
                             role="region"
                             data-timer-delay="5000"
                             aria-label="Product Slider" data-orbit
                             data-options="animInFromLeft:fade-in; animInFromRight:fade-in; animOutToLeft:fade-out; animOutToRight:fade-out;">
