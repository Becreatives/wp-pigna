<div id="barrow" class="orbit barrow" role="region"
     data-timer-delay="5000"
     aria-label="Pigna Slider" data-orbit
                            ...
                            <div class="cell small-12 medium-12 large-5">
                                ...
                                <div class='actionbox'>
                                    <a href="https://www.amazon.it/stores/page/701ABEEB-090A-483F-9263-31A81E827419?ingress=0&visitId=76528668-3ec3-4a69-95d9-d6d58e925ada&lp_slot=auto-sparkle-hsa-tetris&store_ref=SB_A01081933CLS802J4SB4B&ref_=sbx_be_s_sparkle_mcd_logo"
                                       target='_blank' class='btn'><?php _e('SHOP NOW', $textdomain); ?></a>
                                </div>
                    ...
                    <div class="grid-container full" style="width: 100%">
                        <div class="grid-x grid-x align-middle">
                            ...
                            <div class="cell small-12 medium-12 large-5">
                                ...
                                <div class='actionbox'>
                                    <a href="https://www.amazon.it/stores/page/701ABEEB-090A-483F-9263-31A81E827419?ingress=0&visitId=76528668-3ec3-4a69-95d9-d6d58e925ada&lp_slot=auto-sparkle-hsa-tetris&store_ref=SB_A01081933CLS802J4SB4B&ref_=sbx_be_s_sparkle_mcd_logo"
                                       target='_blank' class='btn --slide-2'><?php _e('SHOP NOW', $textdomain); ?></a>
