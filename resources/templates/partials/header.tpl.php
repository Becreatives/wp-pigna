                                ...
                                <div class="grid-container" >
                                    <div class="grid-x grid-x align-middle">
                                        ...
                                        <div class="cell small-12 medium-12 large-5">
                                            <?php if(!$imageTitle) : ?><h1 style="color: #<?= $color ? $color : '000000';?>"><?= htmlspecialchars_decode($title) ?></h1><?php endif;?>
                                            <?php if($imageTitle) : ?>  <img src="<?= $imageTitle['url']; ?>" class="title-logo"><?php endif;?>
                                            <?php if($content) : ?>
                                            <div class="__content" style=" color: #<?= $contentColor ? $contentColor : '000000'; ?>">
