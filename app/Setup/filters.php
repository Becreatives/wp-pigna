...
add_filter('theme/index/sidebar/visibility', 'Pigna\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Pigna\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Pigna\Theme\App\Setup\modify_excerpt_length');
